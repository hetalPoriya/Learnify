...
class AppWidgets {
  static List<DrawerModel> drawerModel = [
    ...
    DrawerModel(
        text: 'Privacy Policy',
        imageString: AppImages.dashboard,
        screenName: RouteHelper.privacyPolicy),
    DrawerModel(
      text: 'Log Out',
  ...
  static Widget elevButton(VoidCallback? onTap, String? text) =>
      GestureDetector(
        onTap: onTap,
        child: Container(
            ...
            child: Padding(
              ...
              child: SingleChildScrollView(
                child: Column(children: [
                  ...
                  //     ?
                  (SharedPrefClass.getBool(AppStrings.isLogin, false) == false)
                      ? ListTile(
                          onTap: () {
                            Get.back();
                            launchURLBrowser();
                          ...
                          leading: Image.asset(AppImages.dashboard,
                              height: 4.h, width: 8.w, color: Colors.white),
                          title: Text('Rate Us',
                              style: AppTextStyles.smallTextStyle()),
                        )
                      : ListView.builder(
  ...
  static launchURLBrowser() async {
    var url = Uri.parse("market://details?id=com.app.learnify");
  ...
  static largeText({String? text, TextDecoration? decoration, Color? color}) =>
      Text(
        text.toString(),
  ...
  static normalText({
    ...
    TextDecoration? decoration,
      ...
      Text(
        ...
        style: AppTextStyles.smallTextStyle()
            .copyWith(color: color ?? Colors.black, decoration: decoration),
      );
